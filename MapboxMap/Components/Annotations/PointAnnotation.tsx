import { ConnectorSpecs } from "components/MapboxMap/Types/mapboxtypes";
...
export const PointAnnotation = ({
  ...
  const anchorTranslateX =
    textAnchor === "center" ? "-50%" : textAnchor === "right" ? "-100%" : "0";
...
const ContentContainer = styled.div<{
  ...
  transform-origin: ${(props) => {
    const h =
      props.$textAnchor === "center"
        ? "center"
        : props.$textAnchor === "right"
          ? "right"
          : "left";
    const v = props.$anchorTop ? "top" : "bottom";
    return `${h} ${v}`;
  }};
